@echo off
REM === DyPOS origin deploy v1789383983652 â€” RUN AS ADMINISTRATOR on the ORIGIN server ===
set SRC=%~dp0
...
iisreset /restart
echo [4/4] Verifying...
findstr /C:"1789383983652" "%DST%\pos.html" && echo BUILD 1789383983652 LIVE || echo VERIFY FAILED
pause