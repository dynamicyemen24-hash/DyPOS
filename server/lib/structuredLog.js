...
/** Core log function */
function log(level, loggerName, message, data, error) {
...
export function createLogger(name) {
	return {
		...
		error: (msg, data, err) => log("error", name, msg, data, err),
		fatal: (msg, data, err) => log("fatal", name, msg, data, err),
		child: (childData) => createChildLogger(name, childData),
	}
}

function createChildLogger(parentName, childData) {
...
export function createBoundLogger(name, correlation) {
...
export function logPerformance(name, duration, success, metadata) {
