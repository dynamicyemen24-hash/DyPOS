...
export async function updateDraft(draftId, invoiceData) {
	...
	// Await outside the Promise executor: an async executor swallows thrown
	// errors and leaves the promise pending forever.
...
export async function deleteDraft(draftId) {
	...
	// Await outside the Promise executor (see updateDraft above).
