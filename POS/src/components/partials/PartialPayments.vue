...
function selectInvoice(invoice) {
	log.debug("[PartialPayments] Select invoice:", {
...
async function handlePaymentCompleted(paymentData) {
	log.debug("[PartialPayments] Payment completed:", {
	...
	try {
		log.debug("[PartialPayments] Calling API to add payment...")
		const result = await call(
			"DyPOS.api.partial_payments.add_payment_to_partial_invoice",
			{
		...
		log.debug("[PartialPayments] API response:", result)

		showSuccess(__("Payment added successfully"))

		// Reload invoices and summary
		log.debug("[PartialPayments] Reloading invoices and summary...")
		await loadInvoices()
		await loadSummary()
