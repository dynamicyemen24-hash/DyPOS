									...
									<div class="max-w-5xl mx-auto">
										...
										>
											...
											<div class="flex items-center gap-2">
												...
												<div
													v-if="isPricingRule"
													class="flex items-center gap-2 px-3 py-1 bg-indigo-50 rounded-lg"
												>
													<FeatherIcon
														name="info"
													...
													/>
													<span
														class="text-xs text-indigo-700 font-medium"
														>{{
														...
														>
															...
															>
																...
																<button
																	...
																	class="ms-1 hover:text-indigo-900"
																>
																	×
																</button>
															</Badge>
...
const promotionsResource = createResource({
	url: "DyPOS.api.promotions.get_promotions",
	makeParams() {
		return {
...
const itemGroupsResource = createResource({
	url: "DyPOS.api.promotions.get_item_groups",
	makeParams() {
...
const brandsResource = createResource({
	url: "DyPOS.api.promotions.get_brands",
	auto: false,
	onSuccess(data) {
		brands.value = data || []
	},
...
const savePromotionResource = createResource({
	url: "DyPOS.api.promotions.create_promotion",
	makeParams() {
...
const updatePromotionResource = createResource({
	url: "DyPOS.api.promotions.update_promotion",
	makeParams() {
		return {
...
const toggleResource = createResource({
	url: "DyPOS.api.promotions.toggle_promotion",
	auto: false,
	onSuccess() {
...
const deleteResource = createResource({
	url: "DyPOS.api.promotions.delete_promotion",
	auto: false,
	onSuccess(data) {
		const responseData = data?.message || data
		const successMessage =
...
const promotionDetailsResource = createResource({
	url: "DyPOS.api.promotions.get_promotion_details",
	makeParams() {
		return {
