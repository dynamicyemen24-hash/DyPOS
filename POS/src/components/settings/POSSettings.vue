		...
		>
			...
			<div class="fixed inset-0 flex items-center justify-center p-4 md:p-6">
				...
				>
					<!-- Header -->
					<div
						class="flex items-center justify-between px-6 py-5 border-b bg-gradient-to-r from-indigo-50 to-indigo-50"
					>
					...
					<div class="flex-1 overflow-y-auto bg-gray-50">
									...
									<div :class="stockSyncSubsectionClasses.container">
										...
										<div class="flex flex-col gap-4">
											...
											<div
												...
												class="ps-6 flex flex-col gap-3 border-s-2 border-indigo-200"
											>
												<NumberField
												...
												>
													<div class="flex items-start gap-2">
														...
														<div
															class="text-xs text-indigo-800 flex flex-col gap-1"
														>
															<TranslatedHTML
																:tag="'p'"
																:inner="
									...
									<div :class="operationsSubsectionClasses.container">
										...
										<div class="flex flex-col gap-3">
											...
											<CheckboxField
												...
												:description="
													__(
														'Show the most recently added item at the top of the cart instead of the bottom.',
													)
												"
											/>
											<CheckboxField
											...
											>
												...
												<div class="flex items-center gap-2">
													...
													<button
														...
														class="ms-auto text-xs px-2 py-1 bg-indigo-100 hover:bg-indigo-200 text-indigo-700 rounded transition-colors"
													>
														{{ __("Retry") }}
													</button>
												</div>
														...
														<div class="flex-1">
															...
															>
																...
																<button
																	...
																	"
																	class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-indigo-600 hover:bg-indigo-700 text-white rounded-md transition-colors"
																>
																	<svg
																		class="w-3.5 h-3.5"
																		fill="none"
						...
						>
							<div :class="appearanceSectionClasses.header">
								<div class="flex items-center justify-between">
									<div class="flex items-center gap-3">
										<div :class="appearanceSectionClasses.iconContainer">
											<svg
												:class="appearanceSectionClasses.icon"
												fill="none"
												stroke="currentColor"
												viewBox="0 0 24 24"
											>
												<path
													...
													stroke-linejoin="round"
													stroke-width="2"
													d="M12 3v1m0 16v1M5.6 5.6l.7.7m12.1 12.1l.7.7M3 12h1m16 0h1M5.6 18.4l.7-.7m12.1-12.1l.7-.7M12 8a4 4 0 100 8 4 4 0 000-8z"
												/>
											</svg>
										</div>
										<div>
											...
											<p class="text-xs text-gray-600 mt-0.5">
												{{
													__(
														"Theme personalization for a comfortable working environment",
													)
												}}
											</p>
										</div>
									</div>
									<div :class="appearanceSectionClasses.badge">
										<svg
											:class="appearanceSectionClasses.badgeIcon"
											fill="none"
											stroke="currentColor"
											viewBox="0 0 24 24"
										>
										...
										<span :class="appearanceSectionClasses.badgeText">{{
											__("Theme")
										}}</span>
									</div>
								</div>
							...
							<div class="p-6 flex flex-col gap-6">
								<div :class="appearanceSubsectionClasses.container">
									<div class="flex items-center gap-2 mb-4">
										<svg
											:class="appearanceSubsectionClasses.icon"
											fill="none"
											stroke="currentColor"
											viewBox="0 0 24 24"
										>
									...
									<div class="flex p-1 bg-gray-200 rounded-lg w-full max-w-md">
										<button
									...
									<p class="text-sm text-gray-600 mt-3">
										<template v-if="isSystem">
											{{ __("Following your device preference") }}
											({{
												resolvedTheme === "dark"
													? __("dark")
													: __("light")
										...
										<template v-else>
											{{
												resolvedTheme === "dark"
													? __("Dark mode is active")
													: __("Light mode is active")
											}}
										</template>
									</p>
								</div>
								...
								<div :class="appearanceSubsectionClasses.container">
									<div class="flex items-center gap-2 mb-4">
										...
										>
											<path
												...
												stroke-linejoin="round"
												stroke-width="2"
												d="M12 3a9 9 0 100 18c.83 0 1.5-.67 1.5-1.5 0-.39-.15-.74-.39-1.01-.23-.26-.38-.61-.38-.99 0-.83.67-1.5 1.5-1.5H16a5 5 0 005-5c0-4.42-4.03-8-9-8zm-3 11a1.5 1.5 0 110-3 1.5 1.5 0 010 3zm3-4a1.5 1.5 0 110-3 1.5 1.5 0 010 3zm3-2a1.5 1.5 0 110-3 1.5 1.5 0 010 3zm2-4a1.5 1.5 0 110-3 1.5 1.5 0 010 3z"
											/>
										</svg>
										<h4 class="text-sm font-semibold text-gray-900">
											{{ __("Accent Color") }}
									...
									<div class="flex flex-wrap gap-3">
										<button
											...
											class="w-10 h-10 rounded-full shrink-0 transition-transform duration-150 hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2"
											:class="
												accent === a.value
													? 'ring-2 ring-offset-2 ring-gray-900 scale-110'
													: 'ring-1 ring-inset ring-black/10'
											"
											:aria-label="__(a.label)"
											:aria-pressed="accent === a.value"
											:title="__(a.label)"
										>
											<svg
												v-if="accent === a.value"
												class="m-auto w-5 h-5 text-white drop-shadow"
												fill="none"
												stroke="currentColor"
												viewBox="0 0 24 24"
											>
									...
									<p class="text-xs text-gray-500 mt-3">
										{{
											__(
												"The accent color is applied across the whole POS instantly.",
											)
										}}
									</p>
								</div>
								...
								<div :class="appearanceSubsectionClasses.container">
									...
									<p class="text-xs text-gray-500 mt-3">
										{{
											__(
												"Compact mode reduces spacing for smaller screens and dense workflows.",
											)
										}}
									</p>
								</div>

								<div :class="shortcutsSubsectionClasses.container">
									<div class="flex items-center gap-2 mb-4">
										<svg
											:class="shortcutsSubsectionClasses.icon"
											fill="none"
											stroke="currentColor"
											viewBox="0 0 24 24"
										>
									...
									>
										...
										>
											...
											<kbd
												class="px-2 py-1 text-xs font-semibold rounded-md bg-gray-100 text-gray-800 border border-gray-300 whitespace-nowrap"
												>{{ s.key }}</kbd
											>
										</div>
									</div>
									<p class="text-xs text-gray-500 mt-3">
										{{
											__(
												"Shortcuts work anywhere in the POS, even while typing.",
											)
										}}
									</p>
								</div>
...
const appearanceSectionClasses = computed(() =>
	getSectionHeaderClasses("purple"),
)
const appearanceSubsectionClasses = computed(() => getSubsectionClasses("gray"))
const shortcutsSubsectionClasses = computed(() => getSubsectionClasses("gray"))

// Theme management (reactive singleton from useAppTheme)
const {
	mode,
	resolvedTheme,
	isSystem,
...
// Accent color presets (swatch hex is display-only; the real token switch
// happens on the <html data-accent> attribute through useAppTheme).
const accentSwatches = [
	{ value: "royal", label: "Royal Blue", color: "#1E40AF" },
...
// Global POS keyboard shortcuts (documented for quick on-boarding).
const shortcuts = [
	{ key: "F2", labelKey: "Sync offline data" },
	{ key: "F6", labelKey: "Open POS Settings" },
	{ key: "F8", labelKey: "Draft invoices" },
	{ key: "F9", labelKey: "Invoice history" },
	{ key: "F10", labelKey: "Stock lookup" },
	{ key: "Shift + Esc", labelKey: "Logout" },
]

// Resources
const warehousesResource = createResource({
	url: "DyPOS.api.pos_profile.get_warehouses",
	makeParams() {
		return {
			pos_profile: props.posProfile,
		}
...
async function loadSettings() {
	...
	try {
		...
		const warehousesData = await call("DyPOS.api.pos_profile.get_warehouses", {
			pos_profile: props.posProfile,
		})
...
async function saveSettings() {
	...
	try {
		...
		const result = await call(
			"DyPOS.DyPOS.doctype.pos_settings.pos_settings.update_pos_settings",
			{
				pos_profile: props.posProfile,
		...
		if (warehouseChanged && selectedWarehouse.value) {
			const warehouseResult = await call(
				"DyPOS.api.pos_profile.update_warehouse",
				{
					pos_profile: props.posProfile,
