...
export const DASHBOARD_TRANSLATIONS = {
	...
	"Real-time sales performance overview":
		"نظرة عامة على أداء المبيعات في الوقت الحقيقي",

	"Finance Dashboard": "لوحة المالية",
	"Cash flow, receivables, and financial health":
		"التدفق النقدي، والمستحقات، والصحة المالية",

	"Inventory Dashboard": "لوحة المخزون",
	"Stock levels, movement, and ABC analysis":
		"مستويات المخزون، والحركة، وتحليل ABC",

	"Customers Dashboard": "لوحة العملاء",
	"Customer analytics, segmentation, and retention":
		"تحليلات العملاء، والتجزئة، والاحتفاظ بهم",
	...
	"Transaction performance, shifts, and payment analysis":
		"أداء المعاملات، والفترات، وتحليل الدفعات",
