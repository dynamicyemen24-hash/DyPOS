<template>
	<div class="relative" ref="selectorRef">
		...
		<button
			...
			class="flex items-center gap-1.5 px-3 py-2 border border-gray-300 rounded-l-lg bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors h-full"
				...
				<div class="sticky top-0 bg-white border-b border-gray-200 p-3">
					<div class="relative">
						<input
							...
							class="w-full ps-9 pe-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
