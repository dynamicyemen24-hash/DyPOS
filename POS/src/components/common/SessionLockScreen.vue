					...
					<div class="bg-white rounded-2xl shadow-2xl p-8">
						...
						<div class="text-center mb-6">
							...
							<div class="flex justify-center mb-3">
								...
								<div
									v-else
									class="w-14 h-14 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold text-lg border-2 border-indigo-500"
								>
									{{ lockedUser?.initials || "??" }}
								</div>
							</div>
						...
						<form @submit.prevent="handleUnlock" class="space-y-4">
							<div>
								...
								<div class="relative">
									<input
										...
										class="block w-full rounded-lg border px-3 py-2.5 pe-10 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 disabled:opacity-50"
										:class="
											verifyError
							...
							<button
								...
								class="w-full px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-sm rounded-lg shadow-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed"
							>
								<span
									v-if="isVerifying"
