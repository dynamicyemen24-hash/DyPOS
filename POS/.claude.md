# Claude Code Rules for DyPOS

This file contains project-specific rules and conventions for Claude Code when working on the DyPOS application.
...
The standard DyPOS `POS Profile` doctype may not have a `customer_group` field. Always check before accessing:
...
*Project: DyPOS - Modern POS System for DyPOS*
