						...
						>
							...
							>
								<button
									...
									class="p-1.5 sm:p-2 hover:bg-indigo-50 rounded-lg transition-colors touch-manipulation disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent"
									:title="
