...
export const sectionThemes = {
	purple: {
		headerGradient: "from-purple-50 via-indigo-50 to-indigo-50",
...
export const subsectionThemes = {
	...
	blue: {
		gradient: "from-indigo-50 to-indigo-50",
...
export function getSectionHeaderClasses(theme) {
	...
	return {
		...
		badge: `flex items-center gap-2 px-3 py-1.5 ${config.badgeBg} rounded-full`,
