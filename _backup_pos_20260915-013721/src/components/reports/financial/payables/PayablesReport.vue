<template>
	<div>
		...
		<h3 class="text-sm font-semibold text-gray-700 mb-3">{{ __("Suppliers") }}</h3>
...
import { buildPayablesModel } from "./payablesCalc"
...
const model = computed(() => buildPayablesModel(props.facts?.payables || []))
...
const partyColumns = [
	{ key: "partyName", label: "Supplier", format: "text", sortable: true },
