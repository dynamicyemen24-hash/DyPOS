...
const errorMessages = {
	sales: { title: "خطأ في لوحة المبيعات", message: "تعذر تحميل بيانات المبيعات" },
	finance: { title: "خطأ في لوحة المالية", message: "تعذر تحميل البيانات المالية" },
	inventory: { title: "خطأ في لوحة المخزون", message: "تعذر تحميل بيانات المخزون" },
	customers: { title: "خطأ في لوحة العملاء", message: "تعذر تحميل بيانات العملاء" },
	executive: { title: "خطأ في لوحة التنفيذيين", message: "تعذر تحميل بيانات التنفيذيين" },
	operations: { title: "خطأ في لوحة العمليات", message: "تعذر تحميل بيانات العمليات" },
}

const currentError = computed(() => {
	return errorMessages[props.dashboardId] || {
		title: "خطأ في اللوحة",
...
onMounted(() => {
	window.addEventListener(`dy:dashboard-error-${props.dashboardId}`, errorHandler)
})

onUnmounted(() => {
	window.removeEventListener(`dy:dashboard-error-${props.dashboardId}`, errorHandler)
})
</script>
