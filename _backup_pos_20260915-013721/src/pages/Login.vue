...
async function submitLogin() {
	...
	if (isRateLimited.value) {
		...
		handleAuthFailure({ stage: "rate_limit", retryAfterMs: rateLimitState.value.retryAfterMs })
		return
	}
	...
	try {
		...
		if (!limitResult.allowed) {
			...
			handleAuthFailure({ stage: "rate_limit", retryAfterMs: limitResult.retryAfterMs })
		} else {
