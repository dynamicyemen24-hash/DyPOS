...
function _checkCertificateOnce() {
	...
	call("DyPOS.api.qz.get_certificate")
		.then((cert) => {
...
export function useQzTray() {
	...
	async function generateCertificate() {
		...
		try {
			const result = await call("DyPOS.api.qz.setup_qz_certificate")
	...
	async function downloadCertificate() {
		try {
			const result = await call("DyPOS.api.qz.get_certificate_download")
			const data = result?.message || result
			if (!data?.pem) {
