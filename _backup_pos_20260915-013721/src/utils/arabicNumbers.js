...
const ARABIC_DIGIT_MAP = Object.fromEntries(ARABIC_DIGITS.map((d, i) => [d, LATIN_DIGITS[i]]))
const LATIN_TO_ARABIC = Object.fromEntries(LATIN_DIGITS.map((d, i) => [d, ARABIC_DIGITS[i]]))
...
export function formatNumber(value, opts = {}) {
	...
	const result = decimals > 0 ? `${formattedInt}${decimalSep}${decPart}` : formattedInt
