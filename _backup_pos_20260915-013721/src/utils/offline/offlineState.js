...
const CONFIG = {
	// Ping settings
	PING_URL: "/api/method/DyPOS.api.ping",
	...
	// Cross-tab sync
	BROADCAST_CHANNEL_NAME: "DyPOS_offline_state",
}
...
class OfflineStateManager {
	...
	_syncToWindow() {
		...
		window.DyPOSManualOffline = this._manualOffline
		window.DyPOSServerOnline = this._serverOnline
	}
