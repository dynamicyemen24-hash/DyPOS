...
```python
from DyPOS.api.wallet import get_customer_wallet_balance
...
```python
from DyPOS.api.wallet import get_wallet_info
...
```python
from DyPOS.api.wallet import create_manual_wallet_credit
...
doc_events = {
    "Customer": {
        "after_insert": "DyPOS.api.customers.auto_assign_loyalty_program"
    },
    "Sales Invoice": {
        "validate": [
