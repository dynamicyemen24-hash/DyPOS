...
- Thermal 80mm print format named `DyPOS EOD Report`
...
- No changes to `DyPOS Receipt` format
...
File: `DyPOS/DyPOS/doctype/pos_closing_shift/pos_closing_shift.js`
