...
DyPOS supports automatic offer application based on cart contents. When items are added to the cart, the system:
...
```python
from DyPOS.api.invoices import apply_offers
