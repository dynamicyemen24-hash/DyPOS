...
class CustomSalesInvoice(SalesInvoice):
	...
	def validate_pos_paid_amount(self):
		...
		1. Pure customer-credit redemption — DyPOS redeems existing customer
		...
		"""
		if getattr(self.flags, "DyPOS_redeemed_customer_credit", 0) or getattr(
			self.flags, "DyPOS_credit_sale", 0
		):
