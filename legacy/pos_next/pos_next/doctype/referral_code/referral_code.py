	...
	coupon.update(
		{
			...
			"discount_amount": flt(referral.referrer_discount_amount)
			if referral.referrer_discount_type == "Amount"
			else None,
	...
	coupon.update(
		{
			...
			"discount_amount": flt(referral.referee_discount_amount)
			if referral.referee_discount_type == "Amount"
			else None,
